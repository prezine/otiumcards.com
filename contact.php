				...
				<div class="container">
					<div class="row">
						...
						<div class="col-xxl-5 col-md-6 ms-auto">
							<p>General enquiries? Partnerships? Feedbacks? Suggestions? Complaints? Doesn't matter, we're always excited to hear from you!</p>
						</div>
					</div>
				</div>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="address-block-one text-center mb-40">
								...
								<p>Open a chat or give us call at <br><a href="tel+2347085884455" class="call">+234 708 588 4455</a></p>
							</div> <!-- /.address-block-one -->
						</div>
						<div class="col-md-4">
							<div class="address-block-one text-center mb-40">
								...
								<p>live chat service <br><a href="contactV2.html#" class="webaddress">www.otiumcards.com</a></p>
							</div> <!-- /.address-block-one -->
						</div>
					</div>
				</div>
										...
										<div class="row controls">
											...
											<div class="col-12">
												<div class="input-group-meta form-group mb-40">
													...
													<select class="theme-select-menu" placeholder="Choose a Complaint...." name="category" required="required">
														<option value="">Choose a Complaint....</option>
														<option value="Card Complaint">Card Complaint</option>
