        ...
        <div class="media align-items-stretch justify-content-center ht-100p pos-relative">
          ...
          <div class="sign-wrapper mg-lg-l-50 mg-xl-l-60">
            <div class="wd-100p">
              ...
              <p class="tx-color-03 tx-16 mg-b-40">Provide your email address to continue</p>

              <div class="form-group">
                <label>Email address</label>
                <input type="email" class="form-control" placeholder="yourname@yourmail.com">
              </div>
              <button class="btn btn-brand-02 btn-block">Send Reset Email</button>
              <div class="tx-13 mg-t-20 tx-center">Just remembered? <a href="./login">Return to login</a></div>
            </div>
          </div><!-- sign-wrapper -->
        </div><!-- media -->
      </div><!-- container -->
