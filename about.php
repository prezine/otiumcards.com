...
<html lang="en">
	<head>
		...
		<meta name="description" content="Otiumcards Description">
      	...
      	<meta property="og:url" content="http://otiumcards.com/about">
		...
		<title>Otiumcards – About us</title>
		<!-- Favicon -->
		...
		<div class="main-page-wrapper">
			...
			<header class="theme-main-menu sticky-menu theme-menu-one white-vr">
				<div class="inner-content">
					<div class="d-flex align-items-center justify-content-between">
						<div class="logo"><a href="./"><img src="images/logo/logo-white.svg" alt="" width="127"></a></div>
						<div class="right-widget d-flex align-items-center">
							<a href="./dash/" class="d-flex align-items-center login-btn">
			...
			<div class="inside-hero-two" style="background-image: url(images/media/img_46.jpg);">
				<div class="container">
					...
					<p>We’re empowering the future with our awesomeness</p>
				</div>
								...
								<div class="accordion-item">
								    ...
								    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionOne">
								    	<div class="accordion-body">
								        	<p>Otiumcards is a contactless card startup based in Nigeria, building the future fo contact for entreprenuers. </p>
								    	</div>
								    </div>
							  	</div>
							  	<div class="accordion-item">
								    ...
								    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionOne">
								      	<div class="accordion-body">
								        	<p>Our goal is to revolutionize the way contacts cards are passed. By building a contactless card that shares contact with a swipe. </p>
								    	</div>
								    </div>
							  	</div>
							  	<div class="accordion-item">
								    ...
								    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionOne">
								    	<div class="accordion-body">
								        	<p>Our vision is to ensure 1 of 2 entreprenuers shares contact seemlessly</p>
								    	</div>
								    </div>
								</div>
							</div>
					...
					<div class="row">
						<div class="col-md-4" data-aos="fade-up">
							<div class="counter-block-three text-center mb-45">
								...
								<p class="theme-mb-0">3,520 avg card swipe per mins</p>
						...
						<div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
							<div class="counter-block-three text-center mb-45">
								...
								<p class="theme-mb-0">Using Otiumcards</p>
							</div> <!-- /.counter-block-three -->
						</div>
					</div>
				</div>
						...
						<div class="col-lg-5">
							<div class="text-wrapper pt-15 md-pb-50">
								<div class="title-style-five">
									...
									<h2 class="title">Why choose Otiumcards.</h2>
								</div>
								<p class="text-lg">The future of contact should be as easy as waving, Otiumcards does that with style</p>
							</div> <!-- /.text-wrapper -->
						</div>
						<div class="col-lg-7">
							<div class="row">
								<div class="col-md-6" data-aos="fade-up">
									<div class="card-style-six">
										...
										<p>Great user experience in how you use.</p>
									</div> <!-- /.card-style-six -->
								</div>
								<div class="col-md-6" data-aos="fade-up">
									<div class="card-style-six">
										...
										<p>24 / 7 Customer support channel</p>
									</div> <!-- /.card-style-six -->
								</div>
					...
					<div class="row align-items-center justify-content-between">
						<div class="col-xxl-8 col-xl-9 col-lg-7 col-md-10 m-auto">
							<div class="title-style-five text-center">
								<h2 class="title">Meet the teaaam 💜</h2>
							</div>
						</div>
					</div>
				</div> <!-- /.container -->
				...
				<div class="team_slider_one box-layout">
					<div class="item">
						<div class="team-block-one position-relative">
							<img src="images/team/img_01.png" alt="" class="team-img w-100">
							<div class="overlay-bg d-flex align-items-end">
								<div class="hover-content tran3s">
									<h6 class="name">Victory Okurakpo</h6>
			...
			=====================================================
			-->
			<div class="box-layout border-top pt-60 mt-30 mb-70 lg-mt-10">
									...
									<div class="row align-items-center">
										...
										<div class="col-md-6">
											<div class="subscribe-form">
												...
												<p>Already sign up? <a href="./about">unsubscribe</a></p>
											</div> <!-- /.subscribe-form -->
										</div>
									</div>
								</div>
								...
								<div class="bottom-footer">
									<div class="row">
										...
										<div class="col-lg-4 order-lg-1 mb-15">
											<p class="copyright text-center">Copyright @2022 otiumcards limited.</p>
										</div>
									</div>
								</div>
							</div>
